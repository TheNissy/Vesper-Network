...
See also the utility's help option. `vesper-blockchain-stats --help`

From the command line run:

`$ vesper-blockchain-stats`
...
- `vesper-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `vesper-blockchain-stats | save-to-database.sh`
